...
class DesignationValidator extends Validator<'get'> {
  ...
  public messages() {
    return {
      'id.required': 'Designation ID is required.',
      'id.uuid': 'Designation ID must be a valid UUID.',
    };
  }
...
export default new DesignationValidator(); 